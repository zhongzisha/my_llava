...
if __name__ == "__main__":
    ...
    if False:
        ...
        parser.add_argument("--model_path", type=str, default="/data/zhongz2/temp29/output_llava_llama_3/pretrain_anyres_debug3/finetune_llama_3_1_with_pretrain")
        ...
        parser.add_argument("--max-new-tokens", type=int, default=256)
        parser.add_argument("--debug", action="store_true")
        # parser.add_argument("--model_path", type=str, default="/data/zhongz2/temp29/output_llava_llama_3/pretrain_anyres_debug3/finetune_qwen_2")
        parser.add_argument("--model_path", type=str, default="/data/zhongz2/temp29/output_llava_llama_3/pretrain_anyres_debug3/finetune_qwen_2_without_pretrain_base/checkpoint-300")
        parser.add_argument("--model_name", type=str, default="llava_qwen_2")
        parser.add_argument("--cache_dir", type=str, default="/data/zhongz2/data/cache_dir/")
        parser.add_argument("--conv_version", type=str, default="qwen_2", choices=['llama_3_1', 'gemma_2', 'qwen_2'])
        parser.add_argument("--device", type=str, default="cuda", choices=["cuda", "mps", "cpu"])
        parser.add_argument("--attn_implementation", type=str, default="flash_attention_2", choices=["eager", "flash_attention_2", "sdpa"])
        parser.add_argument("--load_8bit", action="store_true")
        parser.add_argument("--load_4bit", action="store_true")
        ...
        # parser.add_argument("--model_path", type=str, default="/data/zhongz2/temp29/output_llava_llama_3/pretrain_anyres_debug3/finetune_qwen_2")
        # parser.add_argument("--model_path", type=str, default="/data/zhongz2/temp29/output_llava_llama_3/pretrain_anyres_debug3/finetune_qwen_2_without_pretrain_base/checkpoint-300")
        parser.add_argument("--model_path", type=str, default="/data/zhongz2/temp29/output_llava_llama_3/pretrain_anyres_debug3/finetune_llama_3_1_without_pretrain_conch")
        parser.add_argument("--model_name", type=str, default="llava_llama_3_1")
        parser.add_argument("--cache_dir", type=str, default="/data/zhongz2/data/cache_dir/")
        parser.add_argument("--conv_version", type=str, default="llama_3_1", choices=['llama_3_1', 'gemma_2', 'qwen_2'])
        parser.add_argument("--device", type=str, default="cuda", choices=["cuda", "mps", "cpu"])
