...
from main import load_pretrained_model, tokenizer_image_token, process_anyres_image, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
