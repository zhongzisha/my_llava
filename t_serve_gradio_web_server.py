...
from t_common import LOGDIR, build_logger, server_error_msg, violates_moderation, moderation_msg
from t_main import SeparatorStyle, conv_templates, default_conversation
...
def http_bot(state, model_selector, temperature, top_p, top_k, max_new_tokens, request: gr.Request):
    ...
    try:
        ...
        response = requests.post(worker_addr + "/worker_generate_stream",
            headers=headers, json=pload, stream=True, timeout=20000)
